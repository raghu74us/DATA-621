...
file <- 'https://raw.githubusercontent.com/smithchad17/Week2/master/all-assistance-data.csv'
dset <- read.csv(file)

# read local sentiment file instead
# A sentiment analysis was performed on the description of the award.
file <- 'https://raw.githubusercontent.com/smithchad17/Week2/master/all_awards_sentiment.csv'
